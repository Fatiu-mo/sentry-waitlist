...
export default function Waitlist() {
  ...
  return (
    ...
    >
      ...
      {/* Main Content */}
      <div className="flex items-center mt-40 justify-center px-4 relative z-10">
        <div
          className={`w-full max-w-md p-8 rounded-3xl backdrop-blur-xl transition-all duration-500 relative ${
            isDark
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            >
              SentryBot is your AI-powered crypto lookout, delivering real-time
              Telegram alerts when trending tokens hit DEX Screener. Track
              keywords, stay ahead, and never miss a launch!
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              {/* Button glow effect */}
              <div className="absolute inset-0 bg-gradient-to-r from-blue-400/0 via-cyan-400/20 to-green-400/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          ...
          >
            ...
            >
              <Link
                href="https://x.com/sentrybot_io?t=1dpNNmi541ytYmJ5HCgzRQ&s=09"
                target="_blank"
              >
                𝕏
              </Link>
